...
<h3 class="title"><i class='fas fa-cog'></i> Termékek</h3>
<ul class="description navbar-nav">

     <li class="nav-item">
      <a class="nav-link content-link" href="dashboard.php?cat=product-crud&subcat=admin_page">Termék kezelése</a>
    </li>
    <li class="nav-item">
      <a class="nav-link content-link" href="dashboard.php?cat=product-crud&subcat=filter_page">Kategóriák kezelése</a>
    </li>
