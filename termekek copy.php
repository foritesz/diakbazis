                  ...
                  foreach ($subcategories[$selectedMenuCategory] as $categoryName => $subcategories) {
                      ...
                      foreach ($subcategories as $key => $subcategory) {
                        ...
                        $subcategoryCheck = ($isSubcategoryChecked || $isAlkategoriaSelected) ? 'checked="checked"' : '';
                          ...
                          echo '<div class="checkbox"><label><input type="checkbox" onclick="updateURL()" value="' . $product->cleanString($subcategory) . '" ' . @$subcategoryCheck . ' name="subcategory[]" class="sort_rang subcategory" ">';
